...
## NOTE (archived/optional):
## This script provides one-off signaling QC checks for this
## dataset. It is not required for the main pipeline and can
## be treated as optional legacy QC.
